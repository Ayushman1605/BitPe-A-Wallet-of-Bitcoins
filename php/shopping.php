          ...
          <table class="table table-hover table-sm table-striped table-condensed table-bordered" style="border-color:black;">
            <thead style="color : black;">
              <tr>
                ...
                <th scope="col" class="text-center py-2">Purchase</th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr style="color : black;">
                ...
                <td class="py-2"><img src="../img/mobile.png" alt="mobile" style="width:6em"></td>
              ...
              <tr style="color : black;">
                ...
                <td class="py-2"><img src="../img/watch.png" alt="watch" style="width:6em"></td>
              ...
              <tr style="color : black;">
                ...
                <td class="py-2"><img src="../img/painting.png" alt="painting" style="width:6em"></td>
              ...
              <tr style="color : black;">
                ...
                <td class="py-2"><img src="../img/bike.png" alt="bike" style="width:6em"></td>
