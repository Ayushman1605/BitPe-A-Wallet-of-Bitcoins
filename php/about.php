...
<body style="background-color: cyan;">
  ...
  <footer id="colophon" class="site-footer" role="contentinfo">
    <div class="social-wrapper">
      <ul>
        <li>
          <a href="https://twitter.com/ayushman_tiwari" target="_blank">
            <img src="../img/twitter.png" alt="Twitter Logo" class="icon"></a>
        </li>
        <li>
          <a href="https://mailto:atiwari@iitg.ac.in" target="_blank">
            <img src="../img/gmail.png" alt="Gmail Logo" class="icon"></a>
        </li>
        <li>
          <a href="https://www.linkedin.com/in/ayushman-tiwari-2bb400147/" target="_blank">
            <img src="../img/linkedin.png" alt="Linkedin Logo" class="icon"></a>
        </li>
        <li>
          <a href="https://www.facebook.com/ayushman.tiwari12/" target="_blank">
            <img src="../img/facebook.png" alt="Facebook Logo" class="icon"></a>
        </li>
      </ul>
    </div>
    <nav class="footer-nav" role="navigation">
      <b>&copy; AYUSHMAN TIWARI
        <script>
